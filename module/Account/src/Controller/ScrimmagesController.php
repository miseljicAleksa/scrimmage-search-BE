...
use Workmark\Model\Games;

class ScrimmagesController  extends WorkmarkController
{
    ...
    public function listAction()
    {
    	...
    	$model = $this->container->get(Model::class)->get(Games::class);
    	...
    	$list = (array)$model->getScrimages($REQUEST);
    	...
    	if($totalpage > 1)
    	{
    		...
    		$pagination .= '<li><a  href="/account/scrimmages/list?page=1" class="paginate_click" id="1-page">First</a></li>';
    		for($i = $startCounter; $i <= $loopcounter; $i++)
    		{
    			$activeClass = $currentpage == $i ? 'active' : '';
    			$pagination .= '<li class="'.$activeClass.'"><a href="/account/scrimmages/list?page='.$i.'">'.$i.'</a></li>';
    		}
    		$pagination .= '<li><a href="/account/scrimmages/list?page='.$totalpage.'" class="paginate_click" id="'.$totalpage.'-page">Last</a></li>';
    		$pagination .= '</ul>';
    	}
